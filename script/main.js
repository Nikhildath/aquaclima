...
let lastAlertedAQI = null;

// Show air quality alert (only once per AQI value)
function showAirQualityAlert(message = "Air Quality is BAD!", aqiValue) {
  if (lastAlertedAQI === aqiValue) return; // Already alerted for this value
  lastAlertedAQI = aqiValue;
